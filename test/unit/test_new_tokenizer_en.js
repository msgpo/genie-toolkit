...
const TEST_CASES = [
    ...
    // zipcodes
    ['353 serra mall, stanford ca. 94305', '353 serra mall , stanford ca . 94305', 'NUMBER_0 serra mall , stanford ca . 94305', { NUMBER_0: 353 }],
    ...
    ['at least -3gb', 'at least -3 gb', 'at least -3 gb', {}],
    ['at least -25gb', 'at least -25 gb', 'at least NUMBER_0 gb', { NUMBER_0: -25 }],
    ['at least 1.75 gb', 'at least 1.75 gb', 'at least NUMBER_0 gb', { NUMBER_0: 1.75 }],
    ['at least 1.75, and then some more', 'at least 1.75 , and then some more', 'at least NUMBER_0 , and then some more', { NUMBER_0: 1.75 }],
    ['at least 25, and then some more', 'at least 25 , and then some more', 'at least NUMBER_0 , and then some more', { NUMBER_0: 25 }],
    ['at least 25,000 and then some more', 'at least 25000 and then some more', 'at least NUMBER_0 and then some more', { NUMBER_0: 25000 }],
    ['at least 25,00 and then some more', 'at least 2500 and then some more', 'at least NUMBER_0 and then some more', { NUMBER_0: 2500 }],
    ['at least one', 'at least one', 'at least one', {}],
    ['at least five', 'at least 5', 'at least 5', {}],
    ['at least twelve', 'at least 12', 'at least 12', {}],
    ['at least thirteen', 'at least 13', 'at least NUMBER_0', { NUMBER_0: 13 }],
    ['at least twenty', 'at least 20', 'at least NUMBER_0', { NUMBER_0: 20 }],
    ['at least twenty, one', 'at least 20 , one', 'at least NUMBER_0 , one', { NUMBER_0: 20 }],
    ['at least twenty one', 'at least 21', 'at least NUMBER_0', { NUMBER_0: 21 }],
    ['at least twenty-one', 'at least 21', 'at least NUMBER_0', { NUMBER_0: 21 }],
    ['at least twenty-two', 'at least 22', 'at least NUMBER_0', { NUMBER_0: 22 }],
    ['at least twenty-nine', 'at least 29', 'at least NUMBER_0', { NUMBER_0: 29 }],
    ['at least ninety one', 'at least 91', 'at least NUMBER_0', { NUMBER_0: 91 }],
    ['at least one million', 'at least 1000000', 'at least NUMBER_0', { NUMBER_0: 1e6 }],
    ['at least one million two thousands and three', 'at least 1002003', 'at least NUMBER_0', { NUMBER_0: 1002003 }],
    ['at least 1.75 billions', 'at least 1750000000', 'at least NUMBER_0', { NUMBER_0: 1.75e9 }],
    ['at least a hundred', 'at least 100', 'at least NUMBER_0', { NUMBER_0: 100 }],
    ['at least a thousand', 'at least 1000', 'at least NUMBER_0', { NUMBER_0: 1000 }],
    ['at least twenty two hundreds', 'at least 2200', 'at least NUMBER_0', { NUMBER_0: 2200 }],
    ...
    ['i want the 13th', 'i want the 13th', 'i want the NUMBER_0', { NUMBER_0: 13 }],
    ['i want the 21st', 'i want the 21st', 'i want the NUMBER_0', { NUMBER_0: 21 }],
    ['i want the 21sta', 'i want the 21 sta', 'i want the NUMBER_0 sta', { NUMBER_0: 21 }],
    ['i want the 21rd', 'i want the 21 rd', 'i want the NUMBER_0 rd', { NUMBER_0: 21 }],
    ...
    ['i want the thirteenth', 'i want the 13th', 'i want the NUMBER_0', { NUMBER_0: 13 }],
    ['i want the twentieth', 'i want the 20th', 'i want the NUMBER_0', { NUMBER_0: 20 }],
    ['i want the twenty, first', 'i want the 20 , first', 'i want the NUMBER_0 , first', { NUMBER_0: 20 }],
    ['i want the twenty first', 'i want the 21st', 'i want the NUMBER_0', { NUMBER_0: 21 }],
    ['i want the twenty-first', 'i want the 21st', 'i want the NUMBER_0', { NUMBER_0: 21 }],
    ['i want the twenty-second', 'i want the 22nd', 'i want the NUMBER_0', { NUMBER_0: 22 }],
    ['i want the twenty-ninth', 'i want the 29th', 'i want the NUMBER_0', { NUMBER_0: 29 }],
    ['i want the ninety first', 'i want the 91st', 'i want the NUMBER_0', { NUMBER_0: 91 }],
    ['i want the millionth', 'i want the 1000000th', 'i want the NUMBER_0', { NUMBER_0: 1e6 }],
    ['i want the one million two thousands and third', 'i want the 1002003rd', 'i want the NUMBER_0', { NUMBER_0: 1002003 }],
    ['i want the two billionth', 'i want the 2000000000th', 'i want the NUMBER_0', { NUMBER_0: 2e9 }],
    ['i want the hundredth', 'i want the 100th', 'i want the NUMBER_0', { NUMBER_0: 100 }],
    ['i want the thousandth', 'i want the 1000th', 'i want the NUMBER_0', { NUMBER_0: 1000 }],
    ['i want the twenty two hundredth', 'i want the 2200th', 'i want the NUMBER_0', { NUMBER_0: 2200 }],
    ['i want the twenty three hundreds forty fifth', 'i want the 2345th', 'i want the NUMBER_0', { NUMBER_0: 2345 }],
    ['i want the three hundred thousandth', 'i want the 300000th', 'i want the NUMBER_0', { NUMBER_0: 300000 }],
    ['i want the three hundred fifteen thousandth', 'i want the 315000th', 'i want the NUMBER_0', { NUMBER_0: 315000 }],
    ['i want the three hundred fifteen thousand and second', 'i want the 315002nd', 'i want the NUMBER_0', { NUMBER_0: 315002 }],
    ...
    ['05/32/2020', '5 / 32 / 2020', '5 / NUMBER_0 / NUMBER_1', { NUMBER_0: 32, NUMBER_1: 2020 }],
    ['05/18', '5 / 18', '5 / NUMBER_0', { NUMBER_0: 18, }],
    ...
    ['Show me a picture of restaurants with more than 1,000 reviews.',
     ...
     'show me a picture of restaurants with more than NUMBER_0 reviews .',
     { NUMBER_0: 1000 }],
